...
The structure presented here---\textbf{MPC + Estimator + Target Calculator}---is the standard architecture for linear MPC in process control. We omitted several advanced topics; this chapter provides pointers for further study.
