...
% Title Details
% -------------------------------------------------------------------
\title{\textbf{Model Predictive Control}\\ An Introduction}

\author{Lecture Notes \\ \.Ibrahim K\"u\c c\"ukdemiral }
\date{\today}
...
\begin{document}
	...
	\input{Chapter08V2}
	\input{Chapter9}
	\input{ChapterTubeMPC}
	\input{ChapterNMPC}
	\input{ChapterLearningMPC}
	\input{Chapter10}
	\begin{appendices}
		\input{Appendix1}
		\input{AppendixProbability}
	\end{appendices}
