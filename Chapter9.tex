...
\tikzset{
	...
	slkgreen/.style={slkblock=#1, draw=green!50!black, fill=green!8},
...
\textbf{Layer 1 — the Simulink canvas} contains only standard Simulink
...
\textbf{Layer 2 — the helper \texttt{.m} files} contain all
...
\begin{figure}[htbp]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tikzpicture}[node distance=0.9cm and 3.2cm]
			...
			\end{scope}
			\begin{scope}[on background layer]
				\node[draw=green!50!black, fill=green!4, rounded corners=8pt,
				fit=(hgen)(hplant)(hctrl)(hbuild),
				inner sep=12pt,
				label={[font=\small\bfseries\sffamily\color{green!50!black}]
...
remedy is to insert a \textbf{Unit Delay} block between the controller
...
\begin{figure}[htbp]
	...
	\resizebox{0.82\textwidth}{!}{%
		\begin{tikzpicture}[node distance=0.5cm]
			...
			\begin{scope}[on background layer]
				\node[draw=green!50!black, fill=green!4, rounded corners=6pt,
